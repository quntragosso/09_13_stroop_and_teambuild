...
CREATE TABLE `kqfm_favo_table` (
  ...
  `favo_newsname` varchar(24) COLLATE utf8_unicode_ci NOT NULL,
  `favo_user_id` int(12) NOT NULL,
...
CREATE TABLE `kqfm_like_table` (
  ...
  `like_username` varchar(24) COLLATE utf8_unicode_ci NOT NULL,
...
(1, 'economic news', 'b', 'hogehoge', 'hogehoge', 'test', '2020-07-16 23:16:55', '2020-07-16 23:16:55', 0);
...
(1, 'QunQuuun', 'qwertyasdfgh', 0, 0, '2020-06-29 15:41:48', '2020-06-29 15:41:48'),
...
--
ALTER TABLE `kqfm_like_table`
  MODIFY `like_id` int(12) NOT NULL AUTO_INCREMENT;
